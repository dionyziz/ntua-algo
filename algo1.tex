...
\Procedure{$K^{th}Element_2$}{$A, N_A, B, N_B, k$}
    \If{$N_A + N_B = k$}
        \State \Return $\max( A[ N_A - 1 ], B[ N_B - 1 ] )$
    \EndIf
    \If{$A[ \lfloor \frac{N_A}{2} \rfloor ] \leq B[ \lfloor \frac{N_B}{2} \rfloor ]$}
        \If{$N_A + \lfloor \frac{N_B}{2} \rfloor \geq k$}
            \State \Return \Call{$K^{th}Element_2$}{$A, N_A, B, \lfloor \frac{N_B}{2} \rfloor, k$}
        \EndIf
        \State \Return $B[ k - N_A - \lfloor \frac{N_B}{2} \rfloor ]$
    \Else
        \If{$N_B + \lfloor \frac{N_A}{2} \rfloor \geq k$}
            \State \Return \Call{$K^{th}Element_2$}{$A, \lfloor \frac{N_A}{2} \rfloor, B, N_B, k$}
        \EndIf
...
\Procedure{$K^{th}$}{$A, B, N, k$}
	...
	\State \Return \Call{$K^{th}Element_2$}{$A, N, B, N, k$}
\EndProcedure
\end{algorithmic}
\end{algorithm}
